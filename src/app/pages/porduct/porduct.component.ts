...
products = [
  {
    ...
    tech: [
      "HTML", "SCSS", "TypeScript", "TailwindCSS", "Flowbite",
      "PrimeNG", "NgRx", "API Integration", "Unit Testing",
      "Authentication", "Clean Architecture", "Angular Library"
    ],
  ...
  },
  {
    ...
    tech: [
      "HTML", "SCSS", "TypeScript", "TailwindCSS",
      "Flowbite", "Angular", "API Integration"
    ],
